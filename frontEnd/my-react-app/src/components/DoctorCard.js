...
import './NavBar.css'; // Asegúrate de que el CSS esté importado correctamente
    ...
    <div className="d-flex  mt-4">
      <div className="card text-center mb-3 pt-2" style={{ width: '12rem', border: '2px solid #17a2b8', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.2)' }}>
        <img 
          ...
          alt="Doctor"
          style={{ height: '150px', objectFit: 'cover' }} // Ajuste de imagen para que no distorsione
        />
        <div className="card-body">
          ...
          {/* Botón de Agendar cita con la clase personalizada */}
          <button 
